    ...
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a><i class="fa fa-group"></i>Students<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="customer/list">Student Directory</a></li>
                    <li><a href="customer/add">My Grade Level</a></li>
                    <li><a href="customer/add">My Classroom</a></li>
                </ul>
            </li>
            <li><a><i class="fa fa-group"></i>Teachers & Staff<span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="employee/list">Teachers Directory</a></li>
                    <li><a href="employee/add">Staff Directory</a></li>
                </ul>
            </li>
            ...
            <li><a href="exampleForms"><i class="fa fa-briefcase"></i>Form Examples<span class="fa fa-chevron-down"></span></a>
        </ul>
    </div>
    {{--<div class="menu_section">--}}
    {{--<h3>Live On</h3>--}}
